...
const TOOLS = [
  ...
  },
  {
    ...
    description: 'Guarda un archivo o imagen en Google Drive PVB. Úsalo cuando generes un asset, imagen, PDF, video o diseño que deba quedar registrado. Drive organiza por proyecto automáticamente.',
    input_schema: {
      type: 'object',
      properties: {
